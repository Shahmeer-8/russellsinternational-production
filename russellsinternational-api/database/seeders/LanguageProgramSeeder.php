...
{
    /**
     * The eight starter programs, one set, filed under the section each belongs to.
     * These are the same cards the frontend used to hardcode in DEFAULT_PROGRAMS,
     * so seeding them means the page shows nothing the owner cannot edit.
     *
     * Matches on (section, title) with firstOrCreate: re-running adds anything
     * missing but never overwrites wording the owner has since changed. It
     * previously used updateOrCreate, which reset every field back to these
     * defaults on each run.
     */
